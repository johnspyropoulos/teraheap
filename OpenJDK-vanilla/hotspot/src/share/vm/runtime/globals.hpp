...
#define RUNTIME_FLAGS(develop, develop_pd, product, product_pd, diagnostic, experimental, notproduct, manageable, product_rw, lp64_product) \
  ...
  product(bool, UseLockedTracing, false,                                    \
          ...
          "Deprecated: use FlightRecorder instead")                         \
                                                                            \
  product(bool, FreePhysicalDRAM, false,                                    \
          "Advises the kernel to free physical pages during heap shrinking")\
                                                                            \
  product(bool, FreeYoungGen, false,                                        \
          "Advises the kernel to free physical pages during young "         \
          "generation heap shrinking")                                      \
                                                                            \
  product(bool, FreeOldGen, false,                                          \
          "Advises the kernel to free physical pages during old "           \
          "generation heap shrinking")                                      \
                                                                            \
